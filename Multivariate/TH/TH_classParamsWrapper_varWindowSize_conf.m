function TH_classParamsWrapper_varWindowSize_conf(subjs,just_loso)
%
...
% base save directory
baseDir = '/scratch/jfm2/TH1/multi/gridsearch_varWindowSize_conf_phaseLag';
if ~doBipol
...
texName = 'auc_triangle_conf_bipol';
if doBipol == 0
    texName = 'auc_triangle_conf_avg_ref';
end
if just_loso
