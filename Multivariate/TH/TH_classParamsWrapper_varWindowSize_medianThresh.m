function TH_classParamsWrapper_varWindowSize_medianThresh(subjs,just_loso)
%
...
% base save directory
baseDir = '/scratch/jfm2/TH1/multi/gridsearch_varWindowSize_medianThresh_phaseLag'
if ~doBipol
...
texName = 'auc_triangle_medianTresh_bipol';
if doBipol == 0
    texName = 'auc_triangle_medianTresh_avg_ref';
end
if just_loso
