function TH_classParamsWrapper_varWindowSize_withTranspose(subjs,just_loso)
%
...
% base save directory
baseDir = '/scratch/jfm2/TH1/multi/gridsearch_varWindowSize_withTranspose'
...
for s = 1:length(subjs)
    ...
    if just_loso
        events = get_sub_event('RAM_TH1',subj);
    ...
    if exist(subjFile,'file')
        ...
        parfor ind = 1:totalCalcs
            ...
            if ~isempty(timeWin)
                ...
                params.countTransposedAsCorrect = 1;
...
texName = 'auc_triangle_rec_vs_non_rec_transpose_bipol';
if doBipol == 0
    texName = 'auc_triangle_rec_vs_non_rec_transpose_avg_ref';
end
if just_loso
