function TH_classParamsWrapper_powerAndPhaseLag_refactor(subjs)
%
...
% base save directory
baseDir = '/scratch/jfm2/TH1/multi/gridsearch_500ms_slidingWindow_powAndPhaseLag'
...
% 500 ms window from -500 - 1500, sliding 100 ms
timeBins=num2cell([[25:5:101]' [50:5:125]'],2);
...
texName = 'gridReport_phaseLag.tex';
