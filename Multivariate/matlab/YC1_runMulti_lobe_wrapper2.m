function YC1_runMulti_lobe_wrapper2
%
...
%     end
% end
basePath = '/data10/scratch/jfm2/YC1/multi/lobes'
...
regions = {'mtl','frontal','parietal','occipital','temporal_nonmtl','limbic_nonmtl'};
...
%         4001  5000];   
    ...
    % first do all all
    params.basePath = fullfile(basePath,'All');
    params.region = '';
