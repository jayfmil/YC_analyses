function YC1_runMulti_gridWrapper(subjs)

basePath = '/scratch/jfm2/YC1/multi/watrousGrid';
basePath = '/scratch/jfm2/YC1/multi/pow8_grid_Cs_iterate_subSamp'
...
%                             params.cvField  = 'blocknum';
                            ...
                            YC1_watrous_phase_wSubSamp(subjs{s},params,saveDirSub);
                        end
                    end
                end
            end
