function res=YC2_runApplyWeights(subjs,params)
...
%             chanceData = load(chanceFile);
            ...
            YC2_applyWeights_liblinear(subjs{s},YC1_params,subjData,saveDir);            
        end
    end
...
%             chanceData = load(chanceFile);
            ...
            YC1_params.powerPath = params.powerPath;
            fprintf('Processing %s.\n',subjs{s})
           res = YC2_applyWeights_liblinear(subjs{s},YC1_params,subjData,saveDir);                        
        end
    end
end