function YC1_classParamsWrapper_univarTimeSelection_CV(useWatrous)

% get initial params
baseParams = multiParams;
baseParams.basePath = '/data10/scratch/jfm2/YC1/multi/acrossTrial_modelCompare_univarTime_CV';
regions    = {'all','mtl'};
regions    = {'all'}
