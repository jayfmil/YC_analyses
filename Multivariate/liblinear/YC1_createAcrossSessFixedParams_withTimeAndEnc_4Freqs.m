function YC1_createAcrossSessFixedParams_withTimeAndEnc_4Freqs(subjs)
...
basePath = '/scratch/jfm2/YC1/multi/acrossSess_4Freqs';
params.normType = 'L2';
...
Ts = [51 100;101 150;151 200;201 250;251 300;51 300];
encs = {'first','second'};
