function YC1_classParamsWrapper_acrossSess(useWatrous)

% get initial params
baseParams = multiParams;
baseParams.basePath = '/data10/scratch/jfm2/YC1/multi/acrossSess_modelCompare';
regions    = {'all','mtl'};
...
if ~useWatrous
    ...
    timeBin = {[1 1000;1001 2000;2001 3000;3001 4000;4001 5000]};
...
%     params.powerPath = '/scratch/jfm2/power50freqs';
    ...
    for r = 1:length(regions)
        ...
        for n = 1:nRegTypes
            ...
            YC1_runMulti_phase(subjs,params)
