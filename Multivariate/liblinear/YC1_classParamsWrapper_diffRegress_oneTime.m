function YC1_classParamsWrapper_diffRegress_oneTime(useWatrous)

% get initial params
baseParams = multiParams;
baseParams.basePath = '/data10/scratch/jfm2/YC1/multi/acrossTrial_modelCompare_diffReg_oneTime';
regions    = {'all','mtl'};
