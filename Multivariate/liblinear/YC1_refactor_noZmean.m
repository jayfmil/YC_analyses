function auc = YC1_refactor_noZmean(subj,params,saveDir)
...
if size(subFolds,1) > maxInd
    parfor thisFold = 1:size(subFolds,1)
        ...
        % this will only work with leave one item out because parfor loops
        % are the fucking worst. i can't index it correctly
