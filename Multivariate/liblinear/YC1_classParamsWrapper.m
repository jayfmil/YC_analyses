function YC1_classParamsWrapper(useWatrous)

% get initial params
baseParams = multiParams;
baseParams.basePath = '/data10/scratch/jfm2/YC1/multi/acrossTrial_modelCompare_behBins';
regions    = {'all','mtl'};
regions    = {'all'}
...
if ~useWatrous
    ...
    timeBin = {[1 1000;1001 4000;4001 5000]}
