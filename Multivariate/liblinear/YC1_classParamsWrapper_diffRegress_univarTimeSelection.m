function YC1_classParamsWrapper_diffRegress_univarTimeSelection(useWatrous)

% get initial params
baseParams = multiParams;
baseParams.basePath = '/data10/scratch/jfm2/YC1/multi/acrossTrial_modelCompare_diffReg_univarTime';
regions    = {'all','mtl'};
