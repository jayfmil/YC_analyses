function YC1_runMulti_searchLambda_watrous(subjs)
%
%
%
...
for s = 1:length(subjs)
    try
        ...
        params.alpha = .1;
        params.nCV = 10;
        params.basePath = '/data10/scratch/jfm2/YC1/multi/lambdaSearchWatrous';
        params.saveOutput = 0;
        ...
        for l = 1:length(lambdas)
            ...
            [~,aucs(l,:)] = YC1_runMulti_subj_watrous(subjs{s},params,saveDir);
        ...
        YC1_runMulti_subj_watrous(subjs{s},params,saveDir);
    end
end
