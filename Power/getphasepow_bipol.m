function [varargout] = getphasepow_bipol(chan,events,DurationMS,OffsetMS,BufferMS,varargin)
...
elseif length(chan)==2
    eeg1 = gete_ms(chan(1),events,DurationMS+(2*BufferMS),OffsetMS-BufferMS,0,filtfreq,filttype,filtorder,resampledrate);
    eeg2 = gete_ms(chan(2),events,DurationMS+(2*BufferMS),OffsetMS-BufferMS,0,filtfreq,filttype,filtorder,resampledrate);
    eeg = eeg2-eeg1;
    clear eeg2 eeg1
end
